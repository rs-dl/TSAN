...
class Res_Model_MTRS(nn.Module):

    def __init__(self):
        super(Res_Model_MTRS, self).__init__()
        ...
        self.feature.add_module('view',View(-1, 2048))
        
        self.bottleneck = nn.Linear(2048, 256)
        
        self.class_classifier = nn.Sequential()
        self.class_classifier.add_module('fc_65',nn.Linear(256, 10))            
        ...
        self.dc_ip3_d2 = nn.Linear(1024, 4)
...
class Alex_Model_MTRS(nn.Module):

    def __init__(self):
        super(Alex_Model_MTRS, self).__init__()
        self.feature = nn.Sequential()
        #self.feature.add_module('instance_norm_1', nn.InstanceNorm2d((30,3,227,227)))
        ...
        self.class_classifier = nn.Sequential()
        self.class_classifier.add_module('fc8',nn.Linear(256, 10))
        ...
        self.dc_ip3_mt = nn.Linear(1024, 4)
