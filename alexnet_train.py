...
parser.add_argument("--dataset_name", help="set dataset name, MTRS", default="MTRS")
parser.add_argument("--model_name", help="model name", default="alexnet")
parser.add_argument("--source_name", help="set source domain, form MTRS:(A,N,P,R,U,W)", default="A")
...
parser.add_argument("--test_iter", help="set test iter number", type=int, default=400)
parser.add_argument("--snapshot", help="set which folder to save model and result", default="/data/zjp/MUDO-RSD/snapshot/btdaVATEntropy/")
...
parser.add_argument("--snapshot_file", help="generate folder to save models and result", \
    default='/data/zjp/MUDO-RSD/snapshot/btdaVATEntropy/' + 'alexnet_' + parser.parse_args().source_name+'_VATENT_' + parser.parse_args().dataset_name + time )
...
parser.add_argument("--image_npz_file", help="pack images to npz flie", \
    default= '/data/zjp/MUDO-RSD/dataset/image_npz/'+parser.parse_args().source_name+'.npz' )   
parser.add_argument("--image_test_npz_file", help="pack test images to npz flie to boost test", \
    default= '/data/zjp/MUDO-RSD/dataset/image_npz/'+parser.parse_args().source_name+'_test.npz' )     
