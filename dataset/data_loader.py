...
def get_cluster_loader(args):
    ...
    cluster_set = MTRSImage(args.data_root, train_list ,split="train")
...
def get_noshuffle_loader(args):
    ...
    #cluster train      
    train_list = os.path.join("dataset/MTRS/", target_name_dict[args.source_name]+'_domain_List.txt')
    domain_set = MTRSImage(args.data_root, train_list ,split="train")
...
def get_provided_cluster_loader(args):
    ...
    #cluster train 
    train_list = os.path.join("dataset/MTRS/", target_name_dict[args.source_name]+'_cluster_List.txt')
    cluster_set = MTRSImage(args.data_root, train_list ,split="train")
    cluster_label_raw = torch.utils.data.DataLoader(cluster_set, batch_size=args.batch_size,
        shuffle=True, num_workers=8)   
